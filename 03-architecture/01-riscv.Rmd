...
- Zicsr, extension for user-mode control-status registers.
...
For the Zicsr extension, note that it being disabled does not mean that the *Control Status Register* file (`csr` field/file of `Core`) is disabled.
This register file is required for the operating system to properly work.
