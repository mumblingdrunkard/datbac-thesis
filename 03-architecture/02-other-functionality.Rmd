...
Future development might focus on providing a proper interrupt controller and build abstractions on top of this instead of the crude and minimal interface that currently exists.
...
Note that RISC-V has certain guarantees about *LR/SC-loops* of certain limited length; that they will always be able to eventually progress and avoid livelock.
