...
In the end, the choice was made for us by the requirements of the original project proposal, but it is not a decision we necessarily disagree with.
...
Even though none of the proposed assignments touch on multicore operation, we believe it is important to enable expansion into multicore operating system development if this project is to be a realistic alternative for the full range from introductory to advanced courses.
