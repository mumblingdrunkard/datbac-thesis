...
While not directly relevant to the Gotos project, we would like to briefly argue for the case of splitting the DAT320 course in two or more parts: a systems programming course, and an OS elective.
