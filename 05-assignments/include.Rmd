...
This chapter is a short overview and description of the proposed assignments.
While we originally wanted to create a framework *and* fully featured assignments, we have decided that our limited time is better spent creating a more fully-featured framework which works, rather than focusing on complete assignments without a working framework.
...
However, the general progression of the assignments should be such that a fully working system is incrementally built, which we believe to be the case for the following proposals.
...
## Interlude - Threads and concurrency
