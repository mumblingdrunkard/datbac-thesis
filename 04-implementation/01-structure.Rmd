...
We achieve a safe interface for most resources by only exposing functions with 
...
***TODO:*** system should be able to read from a process' address space.
We should provide interfaces for this.
...
#### Other privileged functionality
