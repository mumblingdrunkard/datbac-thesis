...
Small processors are embedded in everything and "where there's smoke there's fire"; the proverbial smoke being a processor and the proverbial fire being an operating system.
We use these systems without much thought however.
This is thanks to a series of clever abstractions letting us think about the machine as a useful tool for running applications and not a pile of copper and silicon through which electricity is passed.
