# A Teaching Operating System based on Simulation for Third Semester Students {#app:proposal}

**NOTE:** besides this notice, this is a word-for-word copy of the original thesis proposal. @thesis-proposal
...
- [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/) @ostep-web

- [Xv6, a simple Unix-like teaching operating system](https://pdos.csail.mit.edu/6.828/2012/xv6.html) @xv6old

- [Nachos Instructional Operating System](https://homes.cs.washington.edu/~tom/nachos/) @nachos-web

- [Pintos](https://pintos-os.org/) @pintos-web

- [Go Wiki about Test Comments](https://github.com/golang/go/wiki/TestComments) @go-testcomments

- [Go Wiki about Code Review](https://github.com/golang/go/wiki/CodeReviewComments) @go-codereview

- [SOLID Principles in Go](https://dave.cheney.net/2016/08/20/solid-go-design) @solid-go (see also YouTube video linked herein)
