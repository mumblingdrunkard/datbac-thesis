...
- take learnings from these existing systems and design an architecture suitable for third semester students following [textbook](https://pages.cs.wisc.edu/~remzi/OSTEP/)
...
The project is open to a fair bit of flexibility, but the assignments should focus on the topics covered in the lectures and be related to by the textbook that we currently use.
...
The project is expected to produce high-quality Go code, following the established design principles (SOLID) and idiomatic Go and should follow the guidelines linked below.
...
- The first component could be the `Process` simulating a real process, which could be executed one-by-one.
  ...
  Different processes could be initiated with different workloads as part of our tests, which could reveal some weakness in the student implementations of their scheduler or something.
...
- [Operating Systems: Three Easy Pieces](https://pages.cs.wisc.edu/~remzi/OSTEP/)^[https://pages.cs.wisc.edu/~remzi/OSTEP/] @ostep-web

- [Xv6, a simple Unix-like teaching operating system](https://pdos.csail.mit.edu/6.828/2012/xv6.html)^[https://pdos.csail.mit.edu/6.828/2012/xv6.html] @xv6old

- [Nachos Instructional Operating System](https://homes.cs.washington.edu/~tom/nachos/)^[https://homes.cs.washington.edu/~tom/nachos/] @nachos-web

- [Pintos](https://pintos-os.org/)^[https://pintos-os.org/] @pintos-web

- [Go Wiki about Test Comments](https://github.com/golang/go/wiki/TestComments)^[https://github.com/golang/go/wiki/TestComments] @go-testcomments

- [Go Wiki about Code Review](https://github.com/golang/go/wiki/CodeReviewComments)^[https://github.com/golang/go/wiki/CodeReviewComments] @go-codereview

- [SOLID Principles in Go](https://dave.cheney.net/2016/08/20/solid-go-design)^[https://dave.cheney.net/2016/08/20/solid-go-design] @solid-go (see also YouTube video linked herein)
